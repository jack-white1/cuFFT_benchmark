...
start_signal_B_amplitude = 0.005
finish_signal_B_amplitude = 0.0000145
noise_stdev = 0.0
...
for datatype in datatypes:
	...
	for i in signal_B_amplitudes:
		...
		#print("A: ", str(signal_A_amplitude), ", B: ", str(i), ", noise_stdev: ", str(noise_stdev))
...
if os.path.exists('data/processed_json/single_tone_result.json'):
	  		os.remove('data/processed_json/single_tone_result.json')

with open('data/processed_json/single_tone_result.json', 'w') as f:
    json.dump(results, f)